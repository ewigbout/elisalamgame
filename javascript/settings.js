window.images = {
    locations: {
        ...
        stairs: "assets/locations/stairs.png",
        ground_floor: "assets/locations/ground_floor.png"
    },
    actionable: {
        room: {
            nightstand: "assets/actionable/room/nightstand.png",
            bag: "assets/actionable/room/bag.png",
    ...
    phone: {
        calls: "assets/phone/calls",
        mom: "assets/phone/mom"
    }
}
